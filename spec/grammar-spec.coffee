describe 'Language Angelscript (HPS - Soma) package', ->
	...
	describe 'HPS Grammar', ->
		...
		it 'tokenizes descriptors', ->
			{tokens} = grammar.tokenizeLine '[nosave] Object@ obj;'
			expect(tokens[0]).toEqual value: '[nosave]',				scopes: [ 'source.hps', 'meta.descriptor.angelscript' ]
